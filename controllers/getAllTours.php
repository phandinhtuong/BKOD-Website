  ...
  echo json_encode("An unknown error occured!");
    ...
    while ($tourRow = $res->fetchRow()){
        ...
        foreach($tourRow as $key=>$value){
            switch ($key){
                case 0 : $tour["tourID"] = $value; break;
                case 1 : $tour["name"] = $value; break;
                case 2 : $tour["state"] = $value; break;
                case 3 : $tour["imageUrl"] = $value; break;
                case 4 : $tour["date"] = $value; break;
                case 5 : $tour["mapImageUrl"] = $value; break;
                default : break;
            }
        }
        $allTours[] = $tour;
